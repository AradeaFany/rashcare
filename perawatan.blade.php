<html>
    ...
    <body>
        ...
        <div class="row g-0">
            <div class="col-md-4">
            <img src="/image/lansia.jpg" class="img-fluid rounded-start" alt="...">
            </div>
            <div class="col-md-8">
            <div class="card-body">
                <h5 class="card-title">{{ $lansia }}</h5>
                <h6 class="card-subtitle mb-2 text-body-secondary">{{ $descriptionl }}</h6>
        ...
        <div class="row g-0">
            <div class="col-md-4">
            <img src="/image/pascaop.png" class="img-fluid rounded-start" alt="...">
            </div>
            <div class="col-md-8">
            <div class="card-body">
                <h5 class="card-title">{{ $pascaop }}</h5>
                <h6 class="card-subtitle mb-2 text-body-secondary">{{ $descriptionop }}</h6>
                <p class="card-text"><small class="text-body-secondary">10k++ pelanggan</small></p>
            </div>
            </div>
        </div> 
        ...
        <div class="row g-0">
            ...
            <div class="card-body">
                ...
                <h6 class="card-subtitle mb-2 text-body-secondary">{{ $descriptionlyn }}</h6>
                <p class="card-text"><small class="text-body-secondary">10k++ pelanggan</small></p>
            </div>
            </div>
        </div> 
