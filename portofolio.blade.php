<html>
    ...
    <body>
        ...
        <div class="row g-0">
            <div class="col-md-4">
            <img src="/image/aa.png" class="img-fluid rounded-start" alt="...">
            </div>
            <div class="col-md-8">
            <div class="card-body">
        ...
        <div class="row g-0">
            <div class="col-md-4">
            <img src="/image/bb.jpg" class="img-fluid rounded-start" alt="...">
            </div>
            <div class="col-md-8">
            <div class="card-body">
                <h5 class="card-title">{{ $b }}</h5>
                <h6 class="card-subtitle mb-2 text-body-secondary">{{ $bb }}</h6>
                <p class="card-text"><small class="text-body-secondary">10k++ pelanggan</small></p>
            </div>
            </div>
        </div> 
        ...
        <div class="row g-0">
            <div class="col-md-4">
            <img src="/image/cc.jpg" class="img-fluid rounded-start" alt="...">
            </div>
            <div class="col-md-8">
            <div class="card-body">
                <h5 class="card-title">{{ $c }}</h5>
                <h6 class="card-subtitle mb-2 text-body-secondary">{{ $cc }}</h6>
                <p class="card-text"><small class="text-body-secondary">10k++ pelanggan</small></p>
            </div>
            </div>
        </div> 
